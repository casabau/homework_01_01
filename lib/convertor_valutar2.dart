                    ...
                    trailing: Container(
                      ...
                      child: TextField(
                        ...
                        onChanged: (ronValue) {
                          ...
                          controllerUsd.text =
                              '${(ronValue / 4.1).toStringAsFixed(2)}';
                          controllerEur.text =
                              '${(ronValue / 4.7).toStringAsFixed(2)}';
                          controllerGbp.text =
                              '${(ronValue / 5.6).toStringAsFixed(2)}';
                          controllerPln.text =
                              '${(ronValue / 1.1).toStringAsFixed(2)}';
                        },
                    ...
                    trailing: Container(
                      ...
                      child: TextField(
                        ...
                        onChanged: (usdValue) {
                          ...
                          controllerRon.text =
                              '${(usdValue / 0.23).toStringAsFixed(2)}';
                          controllerEur.text =
                              '${(usdValue / 1.1).toStringAsFixed(2)}';
                          controllerGbp.text =
                              '${(usdValue / 1.29).toStringAsFixed(2)}';
                          controllerPln.text =
                              '${(usdValue / 0.26).toStringAsFixed(2)}';
                        },
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(
                          suffixIcon: IconButton(
                    ...
                    trailing: Container(
                      ...
                      child: TextField(
                        ...
                        onChanged: (eurValue) {
                          ...
                          controllerRon.text =
                              '${(eurValue / 0.21).toStringAsFixed(2)}';
                          controllerUsd.text =
                              '${(eurValue / 0.91).toStringAsFixed(2)}';
                          controllerGbp.text =
                              '${(eurValue / 1.18).toStringAsFixed(2)}';
                          controllerPln.text =
                              '${(eurValue / 0.23).toStringAsFixed(2)}';
                        },
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(
                          suffixIcon: IconButton(
                    ...
                    trailing: Container(
                      ...
                      child: TextField(
                        ...
                        onChanged: (gbpValue) {
                          ...
                          controllerRon.text =
                              '${(gbpValue / 0.18).toStringAsFixed(2)}';
                          controllerUsd.text =
                              '${(gbpValue / 0.78).toStringAsFixed(2)}';
                          controllerEur.text =
                              '${(gbpValue / 0.85).toStringAsFixed(2)}';
                          controllerPln.text =
                              '${(gbpValue / 0.2).toStringAsFixed(2)}';
                        },
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(
                          suffixIcon: IconButton(
                    ...
                    trailing: Container(
                      ...
                      child: TextField(
                        ...
                        onChanged: (plnValue) {
                          ...
                          controllerRon.text =
                              '${(plnValue / 0.9).toStringAsFixed(2)}';
                          controllerUsd.text =
                              '${(plnValue / 3.9).toStringAsFixed(2)}';
                          controllerEur.text =
                              '${(plnValue / 4.27).toStringAsFixed(2)}';
                          controllerGbp.text =
                              '${(plnValue / 5.03).toStringAsFixed(2)}';
                        },
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(
                          suffixIcon: IconButton(
